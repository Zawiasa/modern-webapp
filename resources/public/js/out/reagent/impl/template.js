...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__22303__auto__,writer__22304__auto__,opt__22305__auto__){
return cljs.core._write.call(null,writer__22304__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__21705__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__21705__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__21705__auto__)){
return or__21705__auto__;
} else {
...
var G__31660 = o;
(G__31660[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__31662__i < G__31662__a.length) {G__31662__a[G__31662__i] = arguments[G__31662__i + 0]; ++G__31662__i;}
  args = new cljs.core.IndexedSeq(G__31662__a,0);
} 
...
var old_31664 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_31664))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_31664)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__21693__auto__ = (node === document.activeElement);
if(and__21693__auto__){
var and__21693__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__21693__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__31667 = jsprops;
(G__31667["defaultValue"] = value);

(G__31667["onChange"] = ((function (G__31667,v,value,on_change){
return (function (p1__31665_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__31665_SHARP_);
});})(G__31667,v,value,on_change))
);
...
var vec__31669 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__31669,(0),null);
var id = cljs.core.nth.call(null,vec__31669,(1),null);
var class$ = cljs.core.nth.call(null,vec__31669,(2),null);
...
var temp__4427__auto__ = (function (){var G__31673 = cljs.core.meta.call(null,v);
var G__31673__$1 = (((G__31673 == null))?null:reagent.impl.template.get_key.call(null,G__31673));
return G__31673__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__31675_31676 = v;
var G__31675_31677__$1 = (((G__31675_31676 == null))?null:reagent.impl.template.key_from_vec.call(null,G__31675_31676));
var G__31675_31678__$2 = (((G__31675_31677__$1 == null))?null:(jsprops["key"] = G__31675_31677__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__31681 = cljs.core.meta.call(null,argv);
var G__31681__$1 = (((G__31681 == null))?null:reagent.impl.template.get_key.call(null,G__31681));
return G__31681__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__31682 = (((jsprops == null))?{}:jsprops);
(G__31682["key"] = key);
...
var G__31683 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__31683;
continue;
}
} else {
...
var n__22608__auto___31684 = a.length;
var i_31685 = (0);
while(true){
if((i_31685 < n__22608__auto___31684)){
(a[i_31685] = reagent.impl.template.as_element.call(null,(a[i_31685])));

var G__31686 = (i_31685 + (1));
i_31685 = G__31686;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__22608__auto___31687 = a.length;
var i_31688 = (0);
while(true){
if((i_31688 < n__22608__auto___31687)){
var val_31689 = (a[i_31688]);
if((cljs.core.vector_QMARK_.call(null,val_31689)) && ((reagent.impl.template.key_from_vec.call(null,val_31689) == null))){
(o["no-key"] = true);
} else {
}

(a[i_31688] = reagent.impl.template.as_element.call(null,val_31689));

var G__31690 = (i_31688 + (1));
i_31688 = G__31690;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__21693__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__21693__auto__){
return (ctx["no-key"]);
} else {
return and__21693__auto__;
...
var G__31692 = (cljs.core.count.call(null,argv) - first_child);
switch (G__31692) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__31692){
