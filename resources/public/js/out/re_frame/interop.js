...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__45474 = cljs.core.instance_QMARK_;
var expr__45475 = reactive_val;
if(cljs.core.truth_(pred__45474.call(null,reagent.ratom.RAtom,expr__45475))){
return "ra";
} else {
if(cljs.core.truth_(pred__45474.call(null,reagent.ratom.RCursor,expr__45475))){
return "rc";
} else {
if(cljs.core.truth_(pred__45474.call(null,reagent.ratom.Reaction,expr__45475))){
return "rx";
} else {
if(cljs.core.truth_(pred__45474.call(null,reagent.ratom.Track,expr__45475))){
return "tr";
} else {
return "other";
}
