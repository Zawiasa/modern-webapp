...
while (G__31882__i < G__31882__a.length) {G__31882__a[G__31882__i] = arguments[G__31882__i + 0]; ++G__31882__i;}
  args = new cljs.core.IndexedSeq(G__31882__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__31883){
...
return cljs.core.get_in.call(null,new_db,p1__31884_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__31885_SHARP_){
return cljs.core.get_in.call(null,db,p1__31885_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__31886__i = 0, G__31886__a = new Array(arguments.length -  2);
while (G__31886__i < G__31886__a.length) {G__31886__a[G__31886__i] = arguments[G__31886__i + 2]; ++G__31886__i;}
  in_paths = new cljs.core.IndexedSeq(G__31886__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__31887){
var f = cljs.core.first(arglist__31887);
arglist__31887 = cljs.core.next(arglist__31887);
var out_path = cljs.core.first(arglist__31887);
var in_paths = cljs.core.rest(arglist__31887);
